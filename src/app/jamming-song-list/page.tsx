...
5. Ye kaali kaali ankhein
Yeh Kaali Kaali Aankhen
Yeh gore gore gaal
Yeh teekhi teekhi nazren
...
8. Tumse mil ke dil ka hai jo haal kya kahe
...
Tu hai meri Kiran
Tu hai meri Kiran
Faasle aur kum ho rahe hain
Door se paas hum ho rahe hain
Faasle aur kum ho rahe hain
Door se paas hum ho rahe hain
Maang loonga tujhe aasmaan se
Chheen loonga tujhe iss jahaan se
Tu haan kar ya naa kar
Tu haan kar ya naa kar
Tu hai meri Kiran
Tu hai meri Kiran
...
Koyi raaz hain in mein geheraa
Taareef karu kyaa uski
Jis ne tumhein banaayaa
Ek cheez kayaamat bhi hai
Logon se sunaa karate the
Tumhe dekh ke maine maanaa
Wo theek kahaa karate the
Wo theek kahaa karate the
Hai chaal mein teri zaalim
Kuchh aisi balaa kaa jaadoo
...
Ab Aath Pehar Inn Aankhon Mein
Woh Chanchal Mukhra Rehta Hai
Mere Saamne Wali Khidki Mein
Ek Chaand Ka Tukda Rehta Hai
...
mujhe dor koee kheenche teree or lie jae
u u u
door rahatee hai too mere paas aatee nahin
hothon pe tere kabhee pyaas aatee nahin
aisa lage jaise ke too hans ke zahar koee peeye jae
ye shaam mastaanee madahosh kiye jae
mujhe dor koee kheenche teree or lie jae
...
Ho o o gir jaoongi main mar jaoongi
Jo tune mujhe tham na liya, o sau rabadi
Ek ke do, hmmm, do ke char,
Hmmm, mujh ko to, hmmm, dikhte hain
Aisa hi hota hai, jab do dil milte hai
Ek ke do, do ke char, mujh ko to dikhte hain
Aisa hi hota hai, jab do dil milte hai
Sar pe zameen panv ke neeche hai
Aasman ho sau rabadi
...
Tu hi din hai mera, tu hi meri duniya
Tu hi din hai mera, tu hi meri duniya
Tu hi meri shab hai, subha hai, tu hi din hai mera
Tu hi mera rab hai, jahaan hai, tu hi meri duniya
Tu waqt mere liye, main hoon tera lamha
...
Kyun un baahon ko, thandi chhaon ko
...
Aisi raaton main leke karwate
Yaad hamen karna aur phir har kar
Kehna kyun magar keh diya
Alvida ... alvida ... koi poochhe to zara
...
export default function JammingSongList() {
  return (
    <main className="flex min-h-screen flex-col bg-background pt-24">
      <Navbar />
      <section className="container mx-auto px-4 py-12 max-w-4xl flex-grow">
        <h1 className="text-4xl md:text-5xl font-bold font-heading mb-8 text-primary text-center">
          Jamming Song List
        </h1>
        <div className="bg-card p-6 md:p-12 rounded-2xl border border-border shadow-xl">
          <div className="text-lg leading-relaxed text-card-foreground font-serif">
            {LYRICS.split('\n\n').map((verse, i) => {
                ...
                <div key={i} className="mb-10">
                  {lines.map((line, j) => {
                    ...
                    return (
                      <p 
                        key={j} 
                        className={isTitle ? `text-2xl font-bold font-heading mb-4 ${COLORS[i % COLORS.length]}` : "mb-1 text-foreground/80"}
                      >
                        {line}
                      </p>
                    );
